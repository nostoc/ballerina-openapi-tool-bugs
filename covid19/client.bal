...
public isolated client class Client {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post accounts/[string account]/external_accounts(AccountBankAccountsBody payload, map<string|string[]> headers = {}) returns ExternalAccount|error {
        string resourcePath = string `/accounts/${getEncodedUri(account)}/external_accounts`;
        http:Request request = new;
        map<Encoding> requestBodyEncoding = {"bank_account": {style: DEEPOBJECT, explode: true}, "expand": {style: DEEPOBJECT, explode: true}, "metadata": {style: DEEPOBJECT, explode: true}};
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType(), requestBodyEncoding);
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post accounts/[string account]/external_accounts/[string id](BankAccountsidBody payload, map<string|string[]> headers = {}) returns ExternalAccount|error {
        string resourcePath = string `/accounts/${getEncodedUri(account)}/external_accounts/${getEncodedUri(id)}`;
        http:Request request = new;
        map<Encoding> requestBodyEncoding = {"documents": {style: DEEPOBJECT, explode: true}, "expand": {style: DEEPOBJECT, explode: true}, "metadata": {style: DEEPOBJECT, explode: true}};
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType(), requestBodyEncoding);
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post billing/meters/[string id]/deactivate(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns BillingMeter|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post billing/meters/[string id]/reactivate(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns BillingMeter|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post charges/[string charge]/dispute/close(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns Dispute|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post checkout/sessions/[string session]/expire(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns CheckoutSession|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post climate/orders/[string 'order]/cancel(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns ClimateOrder|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post credit_notes/[string id]/void(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns CreditNote|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function delete customers/[string customer]/bank_accounts/[string id](AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns InlineResponse2002|error {
        string resourcePath = string `/customers/${getEncodedUri(customer)}/bank_accounts/${getEncodedUri(id)}`;
        http:Request request = new;
        map<Encoding> requestBodyEncoding = {"expand": {style: DEEPOBJECT, explode: true}};
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType(), requestBodyEncoding);
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post customers/[string customer]/cards(CustomerBankAccountsBody payload, map<string|string[]> headers = {}) returns PaymentSource|error {
        string resourcePath = string `/customers/${getEncodedUri(customer)}/cards`;
        http:Request request = new;
        map<Encoding> requestBodyEncoding = {"bank_account": {style: DEEPOBJECT, explode: true}, "card": {style: DEEPOBJECT, explode: true}, "expand": {style: DEEPOBJECT, explode: true}, "metadata": {style: DEEPOBJECT, explode: true}};
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType(), requestBodyEncoding);
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post customers/[string customer]/cards/[string id](BankAccountsidBody1 payload, map<string|string[]> headers = {}) returns InlineResponse2001|error {
        string resourcePath = string `/customers/${getEncodedUri(customer)}/cards/${getEncodedUri(id)}`;
        http:Request request = new;
        map<Encoding> requestBodyEncoding = {"expand": {style: DEEPOBJECT, explode: true}, "metadata": {style: DEEPOBJECT, explode: true}, "owner": {style: DEEPOBJECT, explode: true}};
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType(), requestBodyEncoding);
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function delete customers/[string customer]/cards/[string id](AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns InlineResponse2002|error {
        string resourcePath = string `/customers/${getEncodedUri(customer)}/cards/${getEncodedUri(id)}`;
        http:Request request = new;
        map<Encoding> requestBodyEncoding = {"expand": {style: DEEPOBJECT, explode: true}};
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType(), requestBodyEncoding);
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post customers/[string customer]/sources(CustomerBankAccountsBody payload, map<string|string[]> headers = {}) returns PaymentSource|error {
        string resourcePath = string `/customers/${getEncodedUri(customer)}/sources`;
        http:Request request = new;
        map<Encoding> requestBodyEncoding = {"bank_account": {style: DEEPOBJECT, explode: true}, "card": {style: DEEPOBJECT, explode: true}, "expand": {style: DEEPOBJECT, explode: true}, "metadata": {style: DEEPOBJECT, explode: true}};
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType(), requestBodyEncoding);
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post customers/[string customer]/sources/[string id](BankAccountsidBody1 payload, map<string|string[]> headers = {}) returns InlineResponse2001|error {
        string resourcePath = string `/customers/${getEncodedUri(customer)}/sources/${getEncodedUri(id)}`;
        http:Request request = new;
        map<Encoding> requestBodyEncoding = {"expand": {style: DEEPOBJECT, explode: true}, "metadata": {style: DEEPOBJECT, explode: true}, "owner": {style: DEEPOBJECT, explode: true}};
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType(), requestBodyEncoding);
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function delete customers/[string customer]/sources/[string id](AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns InlineResponse2002|error {
        string resourcePath = string `/customers/${getEncodedUri(customer)}/sources/${getEncodedUri(id)}`;
        http:Request request = new;
        map<Encoding> requestBodyEncoding = {"expand": {style: DEEPOBJECT, explode: true}};
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType(), requestBodyEncoding);
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post customers/[string customer]/sources/[string id]/verify(IdVerifyBody payload, map<string|string[]> headers = {}) returns BankAccount|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post disputes/[string dispute](ChargeDisputeBody payload, map<string|string[]> headers = {}) returns Dispute|error {
        string resourcePath = string `/disputes/${getEncodedUri(dispute)}`;
        http:Request request = new;
        map<Encoding> requestBodyEncoding = {"evidence": {style: DEEPOBJECT, explode: true}, "expand": {style: DEEPOBJECT, explode: true}, "metadata": {style: DEEPOBJECT, explode: true}};
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType(), requestBodyEncoding);
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post disputes/[string dispute]/close(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns Dispute|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function delete ephemeral_keys/[string 'key](AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns EphemeralKey|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post financial_connections/accounts/[string account]/disconnect(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns FinancialConnectionsAccount|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post identity/verification_sessions/[string session]/cancel(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns IdentityVerificationSession|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post identity/verification_sessions/[string session]/redact(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns IdentityVerificationSession|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post invoices/[string invoice]/mark_uncollectible(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns Invoice|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post invoices/[string invoice]/send(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns Invoice|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post invoices/[string invoice]/void(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns Invoice|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post issuing/authorizations/[string authorization](RefundsidBody payload, map<string|string[]> headers = {}) returns IssuingAuthorization|error {
        string resourcePath = string `/issuing/authorizations/${getEncodedUri(authorization)}`;
        http:Request request = new;
        map<Encoding> requestBodyEncoding = {"expand": {style: DEEPOBJECT, explode: true}, "metadata": {style: DEEPOBJECT, explode: true}};
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType(), requestBodyEncoding);
    ...
    # # Deprecated
    @deprecated
    resource isolated function post issuing/authorizations/[string authorization]/decline(RefundsidBody payload, map<string|string[]> headers = {}) returns IssuingAuthorization|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post issuing/disputes/[string dispute](DisputesdisputeBody payload, map<string|string[]> headers = {}) returns IssuingDispute|error {
        string resourcePath = string `/issuing/disputes/${getEncodedUri(dispute)}`;
        http:Request request = new;
        map<Encoding> requestBodyEncoding = {"evidence": {style: DEEPOBJECT, explode: true}, "expand": {style: DEEPOBJECT, explode: true}, "metadata": {style: DEEPOBJECT, explode: true}};
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType(), requestBodyEncoding);
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post issuing/disputes/[string dispute]/submit(RefundsidBody payload, map<string|string[]> headers = {}) returns IssuingDispute|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post issuing/transactions/[string 'transaction](RefundsidBody payload, map<string|string[]> headers = {}) returns IssuingTransaction|error {
        string resourcePath = string `/issuing/transactions/${getEncodedUri('transaction)}`;
        http:Request request = new;
        map<Encoding> requestBodyEncoding = {"expand": {style: DEEPOBJECT, explode: true}, "metadata": {style: DEEPOBJECT, explode: true}};
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType(), requestBodyEncoding);
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post link_account_sessions(FinancialConnectionsSessionsBody payload, map<string|string[]> headers = {}) returns FinancialConnectionsSession|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post linked_accounts/[string account]/disconnect(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns FinancialConnectionsAccount|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post linked_accounts/[string account]/refresh(AccountRefreshBody payload, map<string|string[]> headers = {}) returns FinancialConnectionsAccount|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post payment_method_domains/[string paymentMethodDomain]/validate(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns PaymentMethodDomain|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post payment_methods/[string paymentMethod]/detach(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns PaymentMethod|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post payouts/[string payout](RefundsidBody payload, map<string|string[]> headers = {}) returns Payout|error {
        string resourcePath = string `/payouts/${getEncodedUri(payout)}`;
        http:Request request = new;
        map<Encoding> requestBodyEncoding = {"expand": {style: DEEPOBJECT, explode: true}, "metadata": {style: DEEPOBJECT, explode: true}};
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType(), requestBodyEncoding);
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post payouts/[string payout]/cancel(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns Payout|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post payouts/[string payout]/reverse(SettlementssettlementBody payload, map<string|string[]> headers = {}) returns Payout|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post quotes/[string quote]/accept(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns Quote|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post quotes/[string quote]/cancel(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns Quote|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post refunds/[string refund](RefundsidBody payload, map<string|string[]> headers = {}) returns Refund|error {
        string resourcePath = string `/refunds/${getEncodedUri(refund)}`;
        http:Request request = new;
        map<Encoding> requestBodyEncoding = {"expand": {style: DEEPOBJECT, explode: true}, "metadata": {style: DEEPOBJECT, explode: true}};
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType(), requestBodyEncoding);
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post refunds/[string refund]/cancel(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns Refund|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post reviews/[string review]/approve(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns Review|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post terminal/readers/[string reader]/cancel_action(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns TerminalReader|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post test_helpers/issuing/authorizations/[string authorization]/expire(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns IssuingAuthorization|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post test_helpers/issuing/cards/[string card]/shipping/deliver(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns IssuingCard|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post test_helpers/issuing/cards/[string card]/shipping/'fail(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns IssuingCard|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post test_helpers/issuing/cards/[string card]/shipping/'return(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns IssuingCard|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post test_helpers/issuing/cards/[string card]/shipping/ship(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns IssuingCard|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post test_helpers/issuing/personalization_designs/[string personalizationDesign]/activate(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns IssuingPersonalizationDesign|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post test_helpers/issuing/personalization_designs/[string personalizationDesign]/deactivate(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns IssuingPersonalizationDesign|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post test_helpers/refunds/[string refund]/expire(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns Refund|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post test_helpers/treasury/inbound_transfers/[string id]/'return(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns TreasuryInboundTransfer|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post test_helpers/treasury/inbound_transfers/[string id]/succeed(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns TreasuryInboundTransfer|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post test_helpers/treasury/outbound_payments/[string id]/'fail(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns TreasuryOutboundPayment|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post test_helpers/treasury/outbound_payments/[string id]/post(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns TreasuryOutboundPayment|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post test_helpers/treasury/outbound_payments/[string id]/'return(IdReturnBody payload, map<string|string[]> headers = {}) returns TreasuryOutboundPayment|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post test_helpers/treasury/outbound_transfers/[string outboundTransfer](OutboundPaymentsidBody payload, map<string|string[]> headers = {}) returns TreasuryOutboundTransfer|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post test_helpers/treasury/outbound_transfers/[string outboundTransfer]/'fail(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns TreasuryOutboundTransfer|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post test_helpers/treasury/outbound_transfers/[string outboundTransfer]/post(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns TreasuryOutboundTransfer|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post topups/[string topup]/cancel(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns Topup|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post transfers/[string transfer](TopupstopupBody payload, map<string|string[]> headers = {}) returns Transfer|error {
        string resourcePath = string `/transfers/${getEncodedUri(transfer)}`;
        http:Request request = new;
        map<Encoding> requestBodyEncoding = {"expand": {style: DEEPOBJECT, explode: true}, "metadata": {style: DEEPOBJECT, explode: true}};
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType(), requestBodyEncoding);
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post transfers/[string transfer]/reversals/[string id](RefundsidBody payload, map<string|string[]> headers = {}) returns TransferReversal|error {
        string resourcePath = string `/transfers/${getEncodedUri(transfer)}/reversals/${getEncodedUri(id)}`;
        http:Request request = new;
        map<Encoding> requestBodyEncoding = {"expand": {style: DEEPOBJECT, explode: true}, "metadata": {style: DEEPOBJECT, explode: true}};
        string encodedRequestBody = createFormURLEncodedRequestBody(check jsondata:toJson(payload).ensureType(), requestBodyEncoding);
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post treasury/inbound_transfers/[string inboundTransfer]/cancel(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns TreasuryInboundTransfer|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post treasury/outbound_payments/[string id]/cancel(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns TreasuryOutboundPayment|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post treasury/outbound_transfers/[string outboundTransfer]/cancel(AccountLoginLinksBody payload, map<string|string[]> headers = {}) returns TreasuryOutboundTransfer|error {
